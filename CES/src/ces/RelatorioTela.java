...
public class RelatorioTela extends javax.swing.JFrame {
    ...
    public RelatorioTela() {
        ...
        RelatorioDAO rdao = new RelatorioDAO();
            if (Files.exists(Paths.get(rdao.filepath))){
                updateTextArea();
            }
    ...
    private void updateTextArea(){
        RelatorioDAO rdao = new RelatorioDAO();
        String textToDisplay = rdao.readCsv();
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(227, 118, 60));
        ...
        jPanel2.setBackground(new java.awt.Color(142, 206, 213));

        jLabel10.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(0, 0, 0));
        jLabel10.setText("Histórico de ações");
